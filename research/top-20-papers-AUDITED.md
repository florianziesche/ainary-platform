...
- **Derived:** "LLMs müssen nicht alles im Parametern speichern" — gut gestützt
...
- **Derived:** "LLMs sind ihre eigenen Critics" — gut gestützt
...
**🔬 EVIDENCE DISCIPLINE:**
- **Evidenced:** Paper existiert, Ergebnisse sind reproduziert
- **Derived:** "LLMs können deliberate planning" — gut gestützt
