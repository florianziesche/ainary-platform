...
## YOUR QUESTION
How does knowledge actually compound with AI assistance — does it follow power laws, linear growth, or does it plateau?

## WHY IT MATTERS
The 'compounding' claim is central to the value prop — if knowledge accumulation plateaus after initial gains, the long-term investment thesis collapses

## EVIDENCE NEEDED
Studies on AI-assisted learning curves, knowledge retention with AI tools, productivity growth patterns over 6+ months
