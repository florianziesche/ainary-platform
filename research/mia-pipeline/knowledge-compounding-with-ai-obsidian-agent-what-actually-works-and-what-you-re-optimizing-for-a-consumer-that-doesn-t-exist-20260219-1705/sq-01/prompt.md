...
## YOUR QUESTION
What percentage of knowledge workers actually maintain structured notes systems (Obsidian/Notion/Roam) beyond the initial 30 days, and what distinguishes sustainers from abandoners?

## WHY IT MATTERS
If <5% sustain PKM systems, building AI agents for Obsidian targets a niche within a niche — the TAM calculation fundamentally changes

## EVIDENCE NEEDED
Longitudinal usage data from PKM tools showing retention curves, user segmentation studies, churn analysis from Obsidian/Notion
