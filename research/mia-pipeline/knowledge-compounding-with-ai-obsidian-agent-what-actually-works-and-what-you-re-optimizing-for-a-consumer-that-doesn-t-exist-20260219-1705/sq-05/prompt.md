...
## YOUR QUESTION
Which user segments actually need calibrated AI outputs (per CT-011, CT-012) vs. those satisfied with 'good enough' responses?

## WHY IT MATTERS
If only high-stakes users (medical, legal) need calibration but they're <10% of market, the technical complexity isn't justified for mass market

## EVIDENCE NEEDED
User research on AI confidence requirements by domain, willingness-to-pay for calibrated outputs, regulatory requirements by industry
