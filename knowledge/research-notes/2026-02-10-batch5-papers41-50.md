...
Dieses Paper ist eine **systematische Review** der Evolution von [[AI]] und [[AI]]-Agenten für Manufacturing. Die Kernfrage: Was sind eigentlich "[[AI]] Agents", "[[LLM]]-Agents", "M[[LLM]]-Agents" und "Agentic [[AI]]" – und wie unterscheiden sie sich? Die Begriffe werden oft synonym verwendet, aber es gibt wichtige Unterschiede.
...
- **M[[LLM]]-Agents:** Multimodal [[LLM]]-Agents (Text + Vision + Audio) für komplexere Wahrnehmung
...
**Capability-Matrix:**
1. **Information Processing:** [[LLM]]s verbessern semantisches Verständnis von unstrukturierten Daten (Logs, Manuals, etc.)
2. **Environmental Perception:** M[[LLM]]s ermöglichen visuelle Inspektion, Roboter-Navigation
3. **Autonomous Decision-Making:** Agentic [[AI]] trifft Entscheidungen ohne menschliche Intervention

**Manufacturing Applications:**
- **Quality Control:** Vision-based M[[LLM]]s für Defekt-Erkennung
- **Predictive Maintenance:** [[LLM]]s analysieren Sensor-Daten, predict Failures
- **Supply Chain Optimization:** Multi-Agent-Systems für Logistik-Koordination
- **Human-Robot Collaboration:** [[LLM]]s als Interface für natürlichsprachliche Roboter-Befehle

**Challenges:**
- **Domain-Specific Knowledge Gap:** General-Purpose [[LLM]]s fehlt Manufacturing-Expertise
- **Real-Time Constraints:** [[LLM]]s sind zu langsam für Time-Critical Control
...
- **Systematische Taxonomie von [[AI]]-Agent-Begriffen** – klärt Verwirrung zwischen [[LLM]]-Agents, M[[LLM]]-Agents, Agentic [[AI]]
...
- **Limitierte Kritik:** Paper ist sehr optimistisch, kritische Perspektiven (z.B. "Wann NICHT [[LLM]]s?") fehlen weitgehend
...
- **M[[LLM]] für CAD-Analysis:** Technische Zeichnungen analysieren, Komplexität einschätzen
...
- **M[[LLM]] für Site-Assessments:** Agent analyzed Fotos von Fabriken, identifiziert Ineffizienzen
...
- **M[[LLM]] für Multimedia-Inhalte:** Videos, Bilder, Diagramme werden indexiert und durchsuchbar gemacht
...
**Realitäts-Check:**
- **Nicht für Safety-Critical:** [[LLM]]s halluzinieren – nicht für direkte Maschinensteuerung geeignet
...
"[[AI]] Agents, [[LLM]]-Agents, M[[LLM]]-Agents, Agentic [[AI]] – sind das nicht alles Buzzwords für dasselbe?
...
M[[LLM]]-Agents = Multimodal (Text + Vision) (sehr neu)
...
→ M[[LLM]] ohne Domain-Training: Halluziniert bei CNC-Tasks
...
4. **Reality-Check:** Wo funktionieren [[LLM]]s NICHT (Safety, Real-Time, Offline)
5. **Hybrid-Architekturen:** Best-of-Both-Worlds – [[LLM]]s + Traditional [[AI]]
...
**Key Insight:** Beide Papers zeigen: [[LLM]]s sind powerful für Manufacturing, aber nur mit domain-specific architectures (RAG, Simulation, Verification).
...
- **Gap:** [[LLM]]s fehlt strategisches Consulting-Wissen – gut für Execution, nicht für Strategy
...
- **Challenge:** Knowledge-Graphs brauchen Structure – [[LLM]]s sind unstructured
...
2 neue Papers zeigen, wie [[LLM]]s CNC-Programming revolutionieren:
...
**Titel:** "From Chatting to Coding: How to Deploy [[LLM]]s for CNC Manufacturing"
...
**[[AI]] Agent Memory** ist die Fähigkeit, Informationen über Zeit zu speichern und abzurufen. Während [[LLM]]s per Default stateless sind (jeder Request ist isoliert), brauchen praktische Agents **Memory** für kontinuierliche Interaktionen. Das Problem: Wie designt man Memory für Agents?
...
- **Implementierung:** Context-Window des [[LLM]]s (z.B. 128K tokens bei GPT-4)
...
- **Context-Length-Limitation:** [[LLM]]s haben finite Context-Windows – nicht alle Memories passen
...
- **ChatCNC, MCCoder, Manufacturing-Agents-Review** zeigen: General-Purpose-[[LLM]]s alleine reichen nicht
