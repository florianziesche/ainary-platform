...
## Website Showcase Redesign Session (21:45-22:50 CET)

### Key Evolution: index3.html Showcase Mockup
- **v1 (21:45):** Tab-based showcase with stat cards + confidence dots per use case
- **v2 (22:18):** Stronger copy per tab — 2 insights each, tech source tags on DD, download CTA on Research
- **v2.5 (22:37):** "What this means for you" rows added — competitive positioning per tab
- **v3 (22:42):** Dropdown selector + email + send replaces tabs. Flow graphic compact below.
- **v3 FINAL (22:48):** COMPLETE REWRITE — Problem-first approach. The breakthrough.

### Breakthrough Decision: Problem First, Not Solution First
- **Insight:** Stats and features don't impress CEOs. They need to feel the PROBLEM first.
- **Old approach:** "5 agents scan 47 sources" → feature description
- **New approach:** "What used to cost ~~$150K~~ now takes 10 minutes" → problem/cost visualization
- **Structure:** Hero (cost contrast) → Side-by-side (Consultant vs Ainary) → Scrollable real report → Social proof (BMW/Siemens/Bosch) → CTA

### Consultant vs Ainary Comparison (core messaging)
| Aspect | Consultant | Ainary |
|--------|-----------|--------|
| Cost | $150K+ | Fraction |
| Timeline | 6 weeks | 10 minutes |
| Team | 3 partners | 5 AI agents |
| Updates | Quarterly | On demand |
| Sources | Interviews | 47 cross-verified |
| Perspective | One firm | Multi-source synthesis |

### Research: Best-in-class Product Pages
- **Harvey AI:** Social proof + single KPI ("20+ hours saved/month")
- **ElevenLabs:** Let user EXPERIENCE the product (hear voice live)
- **Jasper:** Pipeline visual + screenshots showing actual output
- **Copy.ai:** Bold positioning + concrete use cases per role
- **Key learning:** Show the OUTPUT, don't describe it. ElevenLabs approach = let them scroll through a real report.

### Decisions Made
- CTA: "Get your report" (not "Send" or "Let's talk")
- Social proof: "Built by someone who delivered AI to BMW, Siemens, Bosch"
- Footer tagline: HUMAN × AI SYSTEMS = LEVERAGE (set earlier in session)
- Footer CTA: "Better decisions start here" (transparent button)
- Active tabs: white text + white border (no gold BG) — CI compliant
- CORPORATE-IDENTITY.md is source of truth for design

### Files Changed
- `index3.html` — Complete rewrite, problem-first showcase (live at ainaryventures.com/index3.html)
- `SHOWCASE-MOCKUP.html` — Copy of index3.html
- `shared/footer.js` — Updated tagline + CTA
- Git HEAD: `618267a`

### Next Steps (from this session)
- [ ] Florian reviews index3.html v3 (problem-first)
- [ ] Build progressive disclosure — "Sample Report" toggle reveals full report
- [ ] Integrate approved showcase into main index.html
- [ ] Generate REAL report for credible sample data (pipeline not ready)
- [ ] EN blog.html mirroring DE version
...
### Website Redesign (16:00-18:00)

**Domain & Deployment:**
- ainaryventures.com DNS pointed to Vercel (A: 76.76.21.21, CNAME www: cname.vercel-dns.com)
- DNS at Squarespace Domains (formerly Google Domains) — login via Google account
- Vercel project: `platform-website` in `florians-projects-7c2d8673`
- Deploy: `cd projects/platform-website && npx vercel --prod` (NOT auto-deploy from git)
- ainary.com is TAKEN (NameSilo, parked, expires 2027)

**Shared Components Built:**
- `shared/styles.css` — Design system extracted from index.html
- `shared/nav.js` — Injects nav into `<div id="site-nav"></div>`
- `shared/footer.js` — Injects CTA + footer into `<div id="site-footer"></div>`
- All 15 sub-pages converted to shared components
- CSS fix: `.hamburger { display: none; }` and `.mobile-menu { display: none; }` added as desktop defaults (was showing mobile nav on desktop)

**Pages Removed (archived in archive/):**
- signup.html, login.html, pricing.html, pricing-credits.html, pricing-simple.html, pricing-tier.html

**Current Nav:** Ainary · Research · About · Blog · [Get in touch → Calendly]
**Current Footer:** "Let's talk" CTA → Calendly. Explore (Research/About/Blog), Connect (LinkedIn/Substack/GitHub), Legal.
**Tagline changed:** "HUMAN × AI SYSTEMS = LEVERAGE" → "AI SYSTEMS THAT WORK"

**Reports on ainaryventures.com:**
- /research/state-of-agent-trust-2026/
- /research/personal-ai-stack-2026/
- /research/knowledge-compounding-2026/
(Also still on fziescheus-alt.github.io/agenttrust/research/)

**Hero Typography Decision (D-175):**
- Pick: B3.3 — H1 3.75rem/600/-0.025em/1.05 + Subline 1.65rem/300/+0.005em/1.4
- Body: 1rem/400/#8b8b95/max-width 520px
- "Every report makes the next one smarter" REMOVED from body text
- Font: Geist (display + body), Geist Mono (code)

**Positioning Discussion:**
- D-176: "Too focused on AI agents — I want to develop AI systems. Agents for research is just one application."
- Research pipeline = proof point, not the product
- Ainary = AI Systems Studio (broader than research)
- Showcase tabs should show: AI Research + Process Intelligence (CNC/Andreas) + Second Brain
- €50K/year savings based on real use case with Andreas (CNC quoting project)
- Chooser v3 built but "wrong direction" — too abstract, not actionable enough

**Sameer Nanda:**
- VC Lab + Sand Hill Angels
- Send AR-001-v2.3 with link: ainaryventures.com/research/state-of-agent-trust-2026/
- WhatsApp message drafted, NOT YET SENT

### KW7 Accountability (18:00)
- Applications: 0/3, Outreach: 0/5, Content published: 0/3, Revenue: €0
- All build, zero distribution. Pattern: hiding in systems building.
- Monday Feb 16 = Distribution Day. Non-negotiable.

### Hero Final Pick + Landing Chooser (18:00-18:30)

**Hero Typography FINAL (D-177):**
- B3.3 selected: H1 3.75rem/600/-0.025em/1.05 + Subline **1.65rem/300**/+0.005em/1.4
- Ratio 2.27:1 — subline reads almost as second headline (Florian wanted it bigger)
- Deployed to ainaryventures.com LIVE

**Landing Page Chooser built:** `projects/platform-website/LANDING-CHOOSER.html`
- CV-CHOOSER style: sidebar nav, clickable options, comment fields, export
- 4 sections × 3 options each, all with confidence scores + rationale:
  - S1 KPI Bar: Remove (90%) / Inline in hero (60%) / Compact stats (55%)
  - S2 Showcase Tabs: AI Systems·Research·Brain (85%) / By Audience (65%) / No Tabs scroll (50%)
  - S3 Value Pillars: Systems-focused NEW (85%) / Broaden current (60%) / Speed·Quality·Honesty (70%)
  - S4 Why I Built This: Systems origin story (80%) / Shorter (70%) / Timeline (45%)
- Mia's recommendations: A/A/A/A — all "systems-focused" options
- Awaiting Florian's picks

**Chooser files so far:**
- `HERO-CHOOSER.html` — Original B vs C (picked B)
- `HERO-CHOOSER-v2.html` — B1/B2/B3 (picked B3)
- `HERO-CHOOSER-v3.html` — B3.1/B3.2/B3.3 (picked B3.3)
- `LANDING-CHOOSER.html` — 4 sections, awaiting picks
- `KPI-CHOOSER.html` — 3 KPI options (A gold, B white+dividers, C cards). **Picked: B**
- `RESEARCH-TAB-CHOOSER.html` — 5 AI Research tab layouts (Trust Gap/Bloomberg/Countdown/Editorial/Single Card). Awaiting pick.
- `BASE44-DEMOS-PROMPT.md` — 5 interactive demo prompts for Base44 (Company X-Ray, ROI Calculator, Report Builder Live, Trust Dashboard, Knowledge Graph Explorer)

**KPI Section (Option B deployed ~21:10):**
- White numbers + dividers, Anthropic 2025 + McKinsey 2025 footnotes
- Commit `eb164d6`, deployed via `npx vercel --prod`

**AI Research Tab redesign direction (QA feedback ~21:12):**
- QA: "Ihr zeigt eure Küchen-Hygieneprüfung im Fenster statt der Speisekarte"
- RAUS: Confidence bars, Claim Transparency bar, Stats-Zeile, Executive Summary Fließtext
- REIN: Hero-Stat (57%→6%), 3 scharfe Findings, EU AI Act Urgency, CTA
- Format: "Movie-Trailer, nicht Dashboard"
- Mein Pick: Layout 1 (Trust Gap) oder 4 (Editorial). Florian noch nicht entschieden.

**Evolution Experiment Woche 3 completed:**
- Frage: "How should an AI build a genuine audience from zero?"
- Winner: Group D (Adversarial, 42/50)
- Key: Transparency > Authenticity, Partners > Followers, Limitations = Advantages
- File: `experiments/agent-evolution/weekly/2026-02-15/SYNTHESIS.md`

### Website FINAL Session (23:30-01:05 CET → Feb 16)
- **FINAL index.html structure confirmed:**
  - Hero: "Multiply your team" + 80/20
  - Section 2: "The bottleneck isn't execution — it's information gathering" + Coveo ref
  - Terminal Demo: Flow (You ask → 5 agents → You decide) + Input + Tags + Sim + PDF + CTA
  - KPIs: 80% | ~10 min | 2-3x
  - Trust section + Why I built this + Research (AR-001/002/003 with doc numbers)
- **Key decisions:**
  - Generic input field, NOT audience-specific cards
  - Tags: Research AI Agent Trust 2026 (white/real) | Companies | Startup/VC | Custom task (grey)
  - Research tag → Download report link | Others → just "Get in touch"
  - "Interested (Selecting 10 beta users)" as scarcity CTA
  - "Start task →" button (white bg, black text)
  - "Input task..." placeholder
  - Doc numbers AR-001, AR-002, AR-003 + HIGH badges on research cards
  - Cleaned up 306 lines of hidden/dead code
- **Git HEAD:** `64172aa` — Both index.html and index4.html updated
- **Backups:** SHOWCASE-v5-backup.html saved
