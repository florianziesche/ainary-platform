...
*Auto-consolidated: 2026-02-18 14:03 | 17 findings | avg conf: 73% | 6 verified*
...
**claim × ai_trust** (15 findings): 67% of security alerts are ignored by SOC analysts; 84% of LLM outputs are overconfident (verbalized confidence ; 6% of companies achieve 'AI High Performer' status with 2-3x

**claim × obsidian_import** (15 findings): 67% of security alerts are ignored by SOC analysts; 84% of LLM outputs are overconfident (verbalized confidence ; 6% of companies achieve 'AI High Performer' status with 2-3x

**ai_trust × obsidian_import** (15 findings): 67% of security alerts are ignored by SOC analysts; 84% of LLM outputs are overconfident (verbalized confidence ; 6% of companies achieve 'AI High Performer' status with 2-3x
