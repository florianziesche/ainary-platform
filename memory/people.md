...
- **Sven Gleißberg** — BM Glashütte, parteilos, ~41, ex-Banker. +49 172 3488361. Email ready.

## VC
- **Monique Barbanson** — Entelechy Ventures. Meeting 03.02.
- **Emily Fontaine** — IBM Ventures. Fortune Interview analysiert.
- **Paul Baier** — GAI Insights. LinkedIn Message ready.
- **Tomas Papazian** — Kontakt, Email poliert + gesendet.

## Startup / Tech
- **Hendrik** — Keynostic, EXIST-funded Biotech. Coding agents pitch gesendet.
