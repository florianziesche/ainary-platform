...
The cost to add a calibration check to any agent response: $0.005 — three calls to a small language model (Source: Cost of Trust Brief, verified via Anthropic pricing). The cost of not doing it: $5,000 in legal sanctions (Mata v. Avianca, court record), $60 million in customer service fallout (Klarna, CEO earnings call), $7.5 billion in strategic write-downs (Volkswagen Cariad, public filings).
...
The economics are seductive. Per-interaction cost savings of 85–90% compared to human agents (Source: Economics Brief, industry data). Klarna's AI assistant handled two-thirds of all customer inquiries, reduced response times by 82%, and the company reported $60 million in savings with 853 human agents replaced (Source: Competitive Advantage Brief, CEO Siemiatkowski Q3 2025 Earnings Call).
...
**Pressure 1: Deploy fast or die.** The economics are clear: 85–90% cost savings per interaction (Source: Economics Brief). Klarna saved $60 million. McKinsey shows AI High Performers achieve 2–3x productivity gains (Source: Competitive Advantage Brief, McKinsey n=1,993). Companies that don't deploy agents face competitive extinction.
...
| Klarna service fallout | Undisclosed (within $60M savings context) | Competitive Advantage Brief | Reputation + re-hiring |
| Volkswagen Cariad | $7.5 billion write-down | Agent Failures Brief, public filings | Strategic failure |

The ratio between the cheapest calibration check and the smallest documented penalty: **1 to 1,000,000.** $0.005 versus $5,000.

I need to be honest about this comparison. The VW Cariad write-down was a multi-year strategic failure, not a single agent error. Mata v. Avianca involved a lawyer using ChatGPT for case research — not an autonomous agent system. The $0.005 calibration check would not have prevented VW's problems. The juxtaposition is illustrative, not causal.
...
- VW Cariad ($7.5B) was a multi-year strategic failure, not a single agent error — the $0.005 juxtaposition is illustrative, not scientific
...
| 7 | VW Cariad write-down | $7.5B | Agent Failures | Public filings | High | Strategic, not single agent error |
| 8 | Mata v. Avianca sanction | $5,000 | Agent Failures | Court record | High | Low invalidation risk |
| 9 | Klarna savings | $60M | Competitive Advantage | CEO earnings call | High | Corporate claim, potential bias |
