...
And the rework is only the direct cost. The indirect cost is worse: opportunity cost. EY's Work Reimagined Survey (November 2025, n=15,000 employees and 1,500 employers across 29 countries) found that companies are missing up to **40% of projected AI productivity gains** due to gaps in talent strategy, training, and — critically — trust.

[Source: EY Work Reimagined Survey, November 2025. | Confidence: High — Big 4, massive sample across 29 countries.]

Forty percent. So when your AI transformation team projected $20 million in annual productivity gains, the realistic number — absent trust infrastructure — is closer to $12 million. The missing $8 million is the Rework Tax.
...
**Section Confidence: Medium-High** — rework cost figure ($186/mo) is well-cited but traces to a single underlying study. The 40% missed gains figure is independently sourced from EY (High confidence).
...
| 10 | Missed AI productivity gains | 40% | EY Work Reimagined (n=16.5K, Nov 2025) | High |
