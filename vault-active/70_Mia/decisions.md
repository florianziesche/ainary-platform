...
| 19.02 | Evidence-First Flow (D-165) | Extractor VOR Synthesis = Qualitätshebel | Post-hoc Validation |
| 19.02 | Hybrid Pipeline GPT-4o+Sonnet (D-166) | GPT-4o schnell/günstig als Producer, Sonnet skeptisch als Evaluator | Single-Model |
| 19.02 | Exec Research Factory = Goldstandard | Templates A-J, Assumption Register, 4-Ebenen Findings, Asset Builder | Eigenes Format |
| 19.02 | Outline-First > 2-Call Split (D-192) | Google/Elite Pattern, bessere Struktur | Direct generation |
| 19.02 | FutureSight = Home Service, nicht Manufacturing (D-191) | JD sagt "service businesses" = HVAC, Plumber | Manufacturing focus |
| 19.02 | Insight Quality Rule | Opener MUSS Novel Insight sein, kein bekanntes Wissen | Status quo |
| 19.02 | HUNTER = BDR (D-182) | Sucht Kunden nach ICP, nicht nur VC-Jobs | Job-Search only |
| 19.02 | Platform = Firma | AI Workforce Management System, keine existierende Kategorie | Tool/Dashboard |
...
| Datum | Entscheidung | Warum | Alternativen |
|-------|-------------|-------|-------------|
| 19.02 | eval_responses behalten | Für Pre-Flight Layer 3 (LLM-Judge) nutzen | Löschen |
| 19.02 | send-email via gog CLI | Funktioniert bereits, Gmail API → Backlog Q2 | Gmail API direkt (8h) |
| 19.02 | YC Application Q2 | Mit Product + Paying Pilot bewerben >>> Deck only | Jetzt mit Roadmap |
| 19.02 | AgentTrust Merge (trust_scores → trust_skills) | 2 redundante Trust-Systeme = Inkonsistenz-Risiko | Getrennt lassen |

### D-171: AI Outreach Factory als Revenue-Kanal (2026-02-20)
- Generative Reports + Websites in Bulk senden statt einzeln Consulting pitchen
- Unit Economics: €0.50 Kosten, €5-500 Verkaufspreis, 99%+ Marge
- Apollo.io + Instantly.ai als Stack (nicht HubSpot/Salesforce)
- Alternativen: Nur Consulting (skaliert nicht), nur Content (zu langsam)
- Reversibel? Ja — Domains + Accounts kündbar

### D-172: Opus 4.6 = 200K Context, NICHT 1M (2026-02-20)
- 1M = Sonnet 4.5 mit Extended Thinking
- Korrigiert falsche Angabe in MIA Pipeline Spec und früheren Sessions
- RAG-Strategie (12K Prompt) war richtig

### D-173: Reports deployed auf Vercel (2026-02-20)
- MIA-004 + AR-020 v5 live unter ainary-website.vercel.app/research/
- Öffentlich verlinkbar für Outreach, LinkedIn, VC Applications
