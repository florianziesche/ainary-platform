...
- **Issue:** main.sqlite = 205 MB (corrected 2026-02-20, was wrongly listed as 14 GB), disk 4.9 GB free after cleanup
...
### AI Outreach Factory (NEU 2026-02-20)
- **Konzept:** Generative Produkte in Bulk an 1.000+ Firmen/Tag
- **Pipelines:** generate_report.py (Reviews), generate_website.py (Websites)
- **Stack:** Apollo.io (Emails) + Instantly.ai (Sender) + OpenAI (Content)
- **Status:** Pipelines gebaut, Bulk-Infra noch nicht (Domains, Warmup)
- **Revenue-Target:** $8-13K/Monat
- **Nächster Schritt:** Apollo Account + 5 Domains kaufen + Warmup starten
