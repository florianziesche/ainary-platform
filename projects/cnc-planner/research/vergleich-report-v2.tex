...
\begin{itemize}[leftmargin=*, nosep, itemsep=3pt]
\item \textbf{Keine CAD-Analyse:} Operationen müssen manuell definiert werden. goCAD, Spanflug und up2parts analysieren STEP-Dateien auto\-matisch.
\item \textbf{Keine Erfahrungswerte:} Das Tool hat kein Gedächtnis für vergangene Fertigungen. MBS hat über 30~Jahre Erfahrung in den Köpfen der Mitarbeiter und in~b-logic.
...
\item \textbf{Keine komplexen Spannlagen:} Mehrseitige Bearbeitung wird vereinfacht abgebildet.
\end{itemize}
...
\item Lohnfertiger mit 1--10 Mitarbeitern ohne ERP-System
