...
{\footnotesize\color{subtitle}\textit{Zeichnung nicht vorhanden.}}
...
{\footnotesize\color{subtitle}\textit{Zeichnung nicht vorhanden (Zchng. 2500473.01.01.01.01.006).}}
...
\subsection{Pos.~4: Block 2 · Ø120×105×40 · AlMg3 · 5 Stk}

\begin{center}
\includegraphics[width=0.75\textwidth]{zeichnung-block.png}
\end{center}

{\footnotesize Zeichnung: Block Ø120, Höhe 40mm. 4× M8 Gewinde, 2× Ø6 H7 Passbohrung, 1× M12 Gewinde. Schnitt A-A zeigt Ø16 H7 Zentralbohrung mit Absatz.}
...
{\footnotesize Zeichnung zeigt: Rundes Drehteil mit Bohrungsbild. CNC Planer rechnet als Quader — Materialvolumen dadurch überschätzt. Passbohrungen H7 und M8/M12 Gewinde erfordern spezifische OPs die im Planer pauschal geschätzt werden.}

\subsection{Pos.~5: Finger · 85×70×30 · 1.4571 · 20 Stk}

{\footnotesize\color{subtitle}\textit{Zeichnung nicht vorhanden (Zchng. 2500473.01.01.02.01.002).}}
...
\subsection{Pos.~6: Adapterplatte · 85×70×55 · AlMg3 · 10 Stk}

\begin{center}
\includegraphics[width=0.75\textwidth]{zeichnung-adapterplatte.png}
\end{center}

{\footnotesize Zeichnung: Adapterplatte 81×66×50mm (gerundet 85×70×55). Komplexe Geometrie: Ø31,5 Zentralbohrung, Ø20+Ø40 Stufenbohrung, 7× Ø10 + 7× Ø5,5 Bohrkreis, 4× M3, 2× M5, 2× Ø5 H7 + 2× Ø10 H7 Passbohrungen. Fasen 0,5×45°, 1×45°, 3×45°.}
...
{\footnotesize Die Zeichnung zeigt ein deutlich komplexeres Bauteil als die Abmessungen vermuten lassen: 20+ Bohrungen, Passungen H7, Gewinde M3/M5, Stufenbohrungen. CNC Planer kennt diese Features nicht — trotzdem nur +12\,\% HK-Abweichung.}
