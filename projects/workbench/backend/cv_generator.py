...
FUND_CONFIG = {
    ...
    "futuresight": {
        "subtitle": "AI Founder &middot; B2B SaaS GTM &middot; +$5M Raised",
        "summary": "Grew up in a 25-employee family manufacturing business. Built an AI company from zero to €1M+ ACV, 327% revenue growth (BMW, Siemens, Bosch). +$5M raised, team of 15. Now building full-time on AI agents that automate GTM end-to-end. I know what SMB operators need because I grew up watching one run: less complexity, more booked jobs, provable ROI. Ready to go from V1 to first customers to seed round. Based in New York.",
        "proficiencies": [
            ("GTM", "SMB &amp; Enterprise Sales · Pilot Design · Pricing &amp; Packaging · Channel Partnerships · 9% MoM Pipeline Growth"),
            ("AI/ML", "Agentic AI · LLMs · RAG · Computer Vision · Production Deployment"),
            ("Founder", "0 to 1 Company Building · Fundraising (+$5M) · Team Building (0 to 15) · Full P&amp;L Ownership"),
            ("Technology", "Python · Agent Frameworks · Cloud (AWS, GCP) · CI/CD · Rapid Prototyping"),
            ("Affiliations", "Alchemist Accelerator · VC Lab (Decile Group) · UnternehmerTUM"),
            ("Languages", "German (native) · English (fluent)"),
        ],
        "footer": "Florian Ziesche · February 2026",
