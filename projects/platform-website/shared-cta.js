...
document.addEventListener('DOMContentLoaded', function() {
  ...
  el.innerHTML = `
    <!-- CTA Buttons -->
    <section style="padding:60px 0;text-align:center;border-top:1px solid rgba(255,255,255,0.06);">
      <div style="display:flex;gap:16px;justify-content:center;max-width:800px;margin:0 auto;padding:0 24px;">
    ...
    <footer style="padding:60px 0 30px;border-top:1px solid rgba(255,255,255,0.06);">
      <!-- Newsletter -->
      <div style="max-width:800px;margin:0 auto 40px;padding:0 24px;text-align:center;">
        <p style="font-size:0.85rem;color:#8b8b95;margin-bottom:12px;">Stay in the loop.</p>
        <form onsubmit="window.location.href='signup.html';return false;" style="display:flex;gap:8px;justify-content:center;max-width:400px;margin:0 auto 8px;">
          <input type="email" placeholder="Enter your email" required style="flex:1;background:#111116;border:1px solid rgba(255,255,255,0.06);border-radius:8px;padding:10px 14px;color:#ededf0;font-size:0.85rem;font-family:'Inter',-apple-system,sans-serif;outline:none;">
          <button type="submit" style="background:#c8aa50;color:#08080c;border:none;padding:10px 20px;border-radius:8px;font-size:0.8rem;font-weight:500;cursor:pointer;">Subscribe</button>
        </form>
